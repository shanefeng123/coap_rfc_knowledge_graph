...
def test(batch, model):
    ...
    for sample in decoded_test:
        ...
        print(tokenizer.decode(generate(sentence, model, tokenizer)[0]))
    return test_loss
...
with open("../data/sentence_condition_split", "wb") as file:
    pickle.dump(y, file)
